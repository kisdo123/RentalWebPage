...
public class ReadArticleService2 {

	private static ReadArticleService2 instance = new ReadArticleService2();
	
	public static ReadArticleService2 getInstance() {
		return instance;
	}
	
	private ReadArticleService2() {}
