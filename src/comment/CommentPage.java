...
public class CommentPage {
	...
	private List<Comment> commentList; // 게시글 내용을 담고있는 객체들의 리스트
	...
	public CommentPage(List<Comment> commentList, int currentPage, int totalArticles, int size, int blockSize) {
