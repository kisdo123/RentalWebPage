...
<table>
<tr>
	<td class="title"><input type="text" name="title" value="${param.title }" placeholder="제목"><c:if test="${errors.title }">제목을 입력하세요</c:if></td>
</tr>
<tr>
	<td>&nbsp;</td>
</tr>
...
<tr>
	<td colspan="1"><textarea rows="15" cols="90" name="content" placeholder="내용">${param.content }</textarea></td>
</tr>
<tr>
